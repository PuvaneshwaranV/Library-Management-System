class BookAddEditModal extends HTMLElement {
    constructor() {
        ...
        this.Selectors = {
            ...
            lmBookAddEditSaveButton: "#lm_book_add_edit_save_btn",
            resetColumn: "#reset_col",
            saveColumn: "#save_col",
            resetButton: "#reset_btn",
            lmBookAddEditBtn: "#add_new_book",
        };
        ...
        this.addEditBookValidationMessages = {
            lm_book_add_edit_title: {
                ...
                pattern:
                    "Must start with a letter and can contain letters, numbers, or spaces (2-31 characters)",
            },
            lm_book_add_edit_author: {
                required: "Author name is required",
                pattern:
                    "Must start with a letter and may contain only letters and spaces (2-31 characters)",
            },
            lm_book_add_edit_language: { required: "Language is required" },
            lm_book_add_edit_quantity: {
                required: "Book quantity is required",
                pattern: "Book Quantity must between 1-999",
            },
        };
    }
    ...
    binEventHandlers() {
        ...
        $(document).on("click", this.Selectors.lmBookAddEditBtn, () =>
            this.open()
        );
        $(this).on("click", this.Selectors.lmBookAddEditSaveButton, (e) =>
            this.saveBookBtnEventAction(e)
        );
    }
    ...
    initValidation() {
        ...
        form.validate({
            ignore: [],
            onkeyup: false,
            rules: this.addEditBookValidationRules,
            messages: this.addEditBookValidationMessages,
        });
    }
    ...
    reset() {
        ...
        $(this.Selectors.lmBookAddEditSaveButton).text("Save");
    ...
    open(data = null) {
        if (data) {
            ...
            $(
                this.Selectors.form
            ).validate().settings.rules.lm_book_add_edit_quantity.pattern =
                /^[0-9]{1,3}$/;
            $(
                this.Selectors.form
            ).validate().settings.messages.lm_book_add_edit_quantity.pattern =
            ...
            $(this.Selectors.lmBookAddEditLanguage).val(
                data.language.toLowerCase()
            );
            $(this.Selectors.lmBookAddEditSaveButton).text("Update");
